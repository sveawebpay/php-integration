...
class BvDiscountTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_bv_order_sent_incvat_two_decimals_only_one_discount() {        
    print_r("\n\n-----test_bv_order_sent_incvat_two_decimals_only_one_discount()\n");
    ...
    print_r( $request->xmlMessage );
        ...
        //<response>
        //  <transaction id="600088">
        //    <paymentmethod>KORTCERT</paymentmethod>
        //    <merchantid>1130</merchantid>
        //    <customerrefno>2015-05-20T17:01:08 02:00</customerrefno>
        //    <amount>56000</amount>
