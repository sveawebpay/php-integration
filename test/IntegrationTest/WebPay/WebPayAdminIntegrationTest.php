...
//)        
        ...
        // assert that order rows are the same 
        $this->assertEquals( $a_quantity, $queryResponse->orderrows[0]->quantity );
        $this->assertEquals( $a_amountExVat, $queryResponse->orderrows[0]->amountExVat );
        
        $this->assertEquals( $b_quantity, $queryResponse->orderrows[1]->quantity );
        $this->assertEquals( $b_amountExVat, $queryResponse->orderrows[1]->amountExVat );        
        $this->assertEquals( $b_vatPercent, $queryResponse->orderrows[1]->vatPercent );
        $this->assertEquals( $b_articleNumber, $queryResponse->orderrows[1]->articleNumber );
        $this->assertEquals( $b_unit, $queryResponse->orderrows[1]->unit );
        $this->assertStringStartsWith( $b_name, $queryResponse->orderrows[1]->name );
